...
<title>Devops Cloud Technologies - Exclusive DevOps & Cloud Learning Hub</title>
<link rel="stylesheet"
...
<body>
	...
	<div class="container">
		...
		<header>
			<h1> DevOps & Cloud Learning e-commerce Platform</h1> 
			<h4>Contact: +91-xxxxxx xxxx Email: cloud@devops.com</h4> 
		</header>
	...
	<div class="container">
		<footer>@ 2020 Devops Cloud  Technologies. All rights Reserved.</footer>
	</div>
